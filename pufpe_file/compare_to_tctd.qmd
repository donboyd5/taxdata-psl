...
comp_loop <- function(vars){
  ...
  for (i in seq_along(vars)) {
    ...
    print(htmltools::HTML(as_raw_html(tbl)), raw_html = TRUE)
  }
}
...
# for (i in seq_along(incvars)) {
#   sectitle <- paste0(incvars[i], ": ", utcvars$desc[utcvars$vname==incvars[i]])
#   
#   cat(paste0("\n\n### ", sectitle, "\n"))
#   tbl <- tab(collapse, incvars[i], 2021)
#   # print(as_raw_html(tbl), raw_html = TRUE)
#   print(htmltools::HTML(as_raw_html(tbl)), raw_html = TRUE)
# }
...
# Loop through the sections and tables
# for (i in seq_along(dedvars)) {
#   sectitle <- paste0(dedvars[i], ": ", utcvars$desc[utcvars$vname==dedvars[i]])
#   
#   cat(paste0("\n\n### ", sectitle, "\n"))
#   tbl <- tab(collapse, dedvars[i], 2021)
#   # print(as_raw_html(tbl), raw_html = TRUE)
#   print(htmltools::HTML(as_raw_html(tbl)), raw_html = TRUE)
# }
...
# Loop through the sections and tables
# for (i in seq_along(taxvars)) {
#   sectitle <- paste0(taxvars[i], ": ", utcvars$desc[utcvars$vname==taxvars[i]])
#   
#   cat(paste0("\n\n### ", sectitle, "\n"))
#   tbl <- tab(collapse, taxvars[i], 2021)
#   # print(as_raw_html(tbl), raw_html = TRUE)
#   print(htmltools::HTML(as_raw_html(tbl)), raw_html = TRUE)
# }
